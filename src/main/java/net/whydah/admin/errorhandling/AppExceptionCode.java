...
public class AppExceptionCode {
	...
	public static AppException APP_UNABLE_TO_RESET_PASSWORD_8004 = new AppException(Status.ACCEPTED, 8004, "Unable to send reset password notification to user", "", "");
	public static AppException APP_NOCONTENT_8003 = new AppException(Status.NO_CONTENT, 8003, "No content", "", "");
